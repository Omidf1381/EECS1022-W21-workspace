...
public class SequenceApp2 {
	...
	// Stage Stage 2: Compute the result
	String seq = Sequence.getSequence2(ft, d);
	int sum = Sequence.getSum2(ft, d);
	
	// Stage 3: Output the result to console
	System.out.println("Sequance " + seq + " has sum " + sum);  // note. the + operator is overloaded: either numerical addition or string concatenation
